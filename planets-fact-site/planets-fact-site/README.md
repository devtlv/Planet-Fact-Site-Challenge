...
If you choose to use a JS-heavy approach, we provide a local data.json file for the planets. This means you’ll be able to pull the data from there.

You should use React or another Javascript Framework/Library.
You should use Node.js for the back end (ie. routes).

Bonus : Save in the planet facts in the database
